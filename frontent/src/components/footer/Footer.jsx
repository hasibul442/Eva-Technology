          ...
          <div className=' container pt-5'>
            ...
            <div className='col-sm-2'>
              <p className='address'><i className="fad  fa-grip-vertical footer-icon "></i> Business</p>
                ...
                <Link className="footer-menu-link" to='/terms' >Terms & Condition</Link><br/>
                <Link className="footer-menu-link" to='/policy' >Privacy Policy</Link>
            </div>

            <div className='col-sm-4'>
              <p className='address'><i className="fad  fa-grip-vertical footer-icon "></i> BANGLADESH OFFICE</p>
              <span className='p'><i className="fas fa-building"></i>&nbsp;North Tower, Sector #7, Uttara, Dhaka-1230</span><br/>
